...
class TestWorkshopViews(TestCase):
    ...
    def setUp(self):
        ...
        self.workshop_animation         = Workshop_Animation.objects.create(name="judo", available_in_both_cities=True, disabled_friendly=True, new=True, description="")
    ...
    def test_w_animation_details_page(self):
        page = self.client.get(reverse("w_animation_details", args=[self.workshop_animation_type.animation_type, self.workshop_animation.name, self.slot.id]))
        self.assertEqual(page.status_code, 200)
