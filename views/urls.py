...
from .views                     import get_home_page, get_about_page, get_venue, get_venues_list, get_host, get_admin_panel #, get_rate_and_registration_activities_page, get_rate_and_registration_courses_page    
